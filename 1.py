class Life:
    ...
    def __init__(self, name, satiety=250, happiness=250, health=250, money=9999999999999999999999999999999999999999999999, total_days=7560, days_for_death=a, education_list=[], apartments=''):
        self.name=name
